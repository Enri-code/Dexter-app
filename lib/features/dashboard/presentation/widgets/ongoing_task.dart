...
class OngoingTaskWidget extends StatefulWidget {
  const OngoingTaskWidget(this.task, {super.key});

  final TaskItem task;

  @override
  State<OngoingTaskWidget> createState() => _OngoingTaskWidgetState();
}
...
class _OngoingTaskWidgetState extends State<OngoingTaskWidget> {
  ...
  @override
  void didUpdateWidget(covariant OngoingTaskWidget oldWidget) {
              ...
              children: [
                ...
                Transform.scale(
                  ...
                  child: Checkbox(
                    ...
                    value: task.progress == TaskProgress.complete,
